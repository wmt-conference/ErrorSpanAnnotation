...
python3 appraise-preparation/mqm_human_wmt.py --year wmt23 --redundancy 20 --langs en-de --sec-bad "en-de" --sec-tutorial "de-en.mqm" --suffix ".mqm" --sections 0.5 --systems "ONLINE-Y" "refA" | grep "\["
python3 appraise-preparation/mqm_human_wmt.py --year wmt23 --redundancy 20 --langs en-de --sec-bad "en-de" --sec-tutorial "de-en.esa" --suffix ".esa" --sections 0.5 --systems "ONLINE-Y" "refA" | grep "\["
...
python3 appraise-preparation/mqm_human_wmt.py --year wmt23 --redundancy 20 --langs en-cs --suffix "_gemba" --mqm "metric-scores/en-cs/GEMBA-MQM-xml-GPT4-src"  --sections 1 --systems "ONLINE-Y" "refA" | grep "\["
...
python3 appraise-preparation/mqm_human_wmt.py --year wmt23 --redundancy 20 --langs en-cs --suffix "_comet" --mqm "metric-scores/en-cs/XCOMET-XL"  --sections 1 --systems "ONLINE-Y" "refA" | grep "\["
python3 appraise-preparation/mqm_human_wmt.py --year wmt23 --redundancy 20 --langs en-de --suffix "_hummqm" --mqm "human-scores/en-de.mqm.merged" --sections 1 --systems "ONLINE-Y" "refA" | grep "\["