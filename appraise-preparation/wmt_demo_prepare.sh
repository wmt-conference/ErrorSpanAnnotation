...
python3 appraise-preparation/mqm_human_wmt.py --year wmt23 --redundancy 20 --langs en-cs --tutorial "" --suffix "_gemba" --mqm "metric-scores/en-cs/GEMBA-MQM-xml-GPT4-src" --tasks-per-section 1 --sections 1 --systems "ONLINE-Y" "refA" | grep "\["
...
python3 appraise-preparation/mqm_human_wmt.py --year wmt23 --redundancy 20 --langs en-cs --tutorial "" --suffix "_comet" --mqm "metric-scores/en-cs/XCOMET-XL" --tasks-per-section 1 --sections 1 --systems "ONLINE-Y" "refA" | grep "\["
python3 appraise-preparation/mqm_human_wmt.py --year wmt23 --redundancy 20 --langs en-de --tutorial "" --suffix "_hummqm" --mqm "human-scores/en-de.mqm.merged" --tasks-per-section 1 --sections 1 --systems "ONLINE-Y" "refA" | grep "\["