...
python3 interface/mqm_human_wmt.py --year wmt23 --redundancy 20 --langs en-ru --no-mqm --tasks-per-section 1 --sections 1 --systems "ONLINE-Y" "refA" | grep "\["
python3 interface/mqm_human_wmt.py --year wmt23 --redundancy 20 --langs en-zh --no-mqm --tasks-per-section 1 --sections 1 --systems "ONLINE-Y" "refA" | grep "\["
