...
import ipdb
from ESA.annotations import AppraiseAnnotations, SCHEME_ESA, SCHEME_GEMBA, SCHEME_MQM, SCHEME_ESA2, SCHEME_GEMBA2


class MergedAnnotations:
    def __init__(self, second_campaign=False) -> None:
        if not second_campaign:
            schemes = [SCHEME_MQM, SCHEME_ESA, SCHEME_GEMBA]
        else:
            schemes = [SCHEME_MQM, SCHEME_ESA2, SCHEME_GEMBA2]
